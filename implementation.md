...
**Verification**
- `cargo test -p rub3-wrapper --lib` (default tier-2 + webview): 59 tests, up from 58 (58 pass, 1 ignored network test)
- `cargo test -p rub3-wrapper --no-default-features --features tier-3 --lib`: 67 tests, up from 62 (66 pass, 1 ignored)
- `cargo test -p rub3-wrapper --no-default-features --features tier-3,headless --lib`: 112 tests (111 pass, 1 ignored)
