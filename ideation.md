...
The plan has since been reoriented agent-first (see [implementation.md](implementation.md)): the next work is headless activation, USDC/EIP-3009 purchases, the fee-stamping factory, ownership-invariant hardening, and the CLI — ahead of WalletConnect and other human-surface polish. Tier-4 device binding and binary encryption are deferred.
